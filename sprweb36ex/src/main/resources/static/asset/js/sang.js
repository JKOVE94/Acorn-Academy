...
const hideother = () => {
	document.getElementById('update-tab').setAttribute('class', 'nav-link hide');
	document.getElementById('delete-tab').setAttribute('class', 'nav-link hide');
}
...
const gohome = () => {
	...
	updateli.setAttribute('class', 'nav-link hide');
	...
	deleteli.setAttribute('class', 'nav-link hide');
